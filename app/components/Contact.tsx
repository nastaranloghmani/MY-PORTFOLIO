    ...
    <section id="contact" style={{ padding: "120px 32px 100px", maxWidth: 1200, margin: "0 auto", borderTop: "1px solid #e8e8e8" }}>
      <div ref={ref}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "#aaa" }}>005</span>
        ...
        <div style={{
          ...
          <p style={{
            ...
            <span style={{ color: "#1a4f6e" }}>Let's make it real.</span>
          </p>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 12, color: "#bbb", letterSpacing: "0.04em" }}>
            © 2025 Nastaran Loghmani
          </span>
